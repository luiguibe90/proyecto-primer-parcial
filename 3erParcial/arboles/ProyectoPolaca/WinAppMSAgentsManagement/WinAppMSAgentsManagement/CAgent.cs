...
namespace WinAppMSAgentsManagement
{
    class CAgent
    {
        ...
        public void LeerTexto() {
            using (StreamReader read = new StreamReader(@"G:\Documentos\GitHub\proyecto-primer-parcial\Proyecto_1er_Parcial_boletos_1_bus\Proyecto2doParcial\CalculadoraPolaca\ProyectoPolaca\respaldo.txt")) 
            {
