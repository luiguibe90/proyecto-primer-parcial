...
string postfija(string expresion, int num) {
	...
	system("Start C:/Users/luigu/Desktop/polacaproyectoAg/ProyectoPolaca/ProyectoPolaca/WinAppMSAgentsManagement/WinAppMSAgentsManagement/bin/Debug/WinAppMSAgentsManagement.exe");
	valor = Evalua(post, v);
